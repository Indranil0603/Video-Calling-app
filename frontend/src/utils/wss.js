...
export const connectWithSocketyIOSever = () => {
	socket = io(SERVER);
...
export const createNewRoom = (identity, onlyAudio) => {
	//emit and event ot server that we would like to create new room
	const data = {
		identity,
		onlyAudio,
	};
...
export const joinRoom = (identity, roomId, onlyAudio) => {
	//emit and event to server that we would like to join a room
	const data = {
		roomId,
		identity,
		onlyAudio,
